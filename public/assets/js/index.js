...
/** Stores the maximum recording time in seconds to stop recording once maximum recording Seconds has been reached */
var maximumRecordingTimeInSeconds = 15;
...
function elapsedTimeReachedMaximumNumberOfHours(elapsedTime) {
    ...
    // console.log("elapsedTimeSplitted: "+elapsedTimeSplitted);
    // console.log("elapsedTimeSplitted: "+elapsedTimeSplitted);
    // console.log("elapsedTimeSplitted.length: "+elapsedTimeSplitted.length);
    // console.log("elapsedTimeSplitted[1]: "+elapsedTimeSplitted[1]);
    ...
    //Turn the maximum recording time in hours to a string and pad it with zero if less than 10
    let maximumRecordingTimeInSecondsAsString = maximumRecordingTimeInSeconds < 10 ? "0" + maximumRecordingTimeInSeconds : maximumRecordingTimeInSeconds.toString();
    ...
    //if it the elapsed time reach the maximum recording time in seconds return true
    if (elapsedTimeSplitted.length === 2 && elapsedTimeSplitted[1] === maximumRecordingTimeInSecondsAsString)
        return true;
    else //otherwise, return false
        return false;
}
