  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="social-links d-none d-md-flex align-items-center">
        ...
        <a target="_blank" href="https://www.facebook.com/DoniFab/" class="facebook"><i class="bi bi-facebook"></i></a>
        {{-- <a href="#" class="instagram"><i class="bi bi-instagram"></i></a> --}}
        <a target="_blank" href="https://www.linkedin.com/in/mahamadou-kone-42597b185/" class="linkedin"><i class="bi bi-linkedin"></i></i></a>
      </div>
    </div>
  </section>
